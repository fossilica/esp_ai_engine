...
#ifndef _ESP_AI_BOARD_AUDIO_INPUT_DEVICE_SPH0645_H_
#define _ESP_AI_BOARD_AUDIO_INPUT_DEVICE_SPH0645_H_

#include <driver/i2s_std.h>

#include "audio_input_device.h"

class AudioInputDeviceSph0645 : public esp_ai::AudioInputDevice {
 public:
